...
/**
 * Wipes all local state: the game library ([GameRepository]) and the stored Steam/GOG/PSN/Epic
 * secrets ([SecureStorage]). One seam so both platforms share a single, testable implementation.
 */
